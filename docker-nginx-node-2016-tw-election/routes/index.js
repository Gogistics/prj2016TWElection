...
router.get('/', function(req, res, next) {
  ...
  var page_info = {
    ...
    twitter_title : index_info[lang]['twitter_section']['title'],
    twitter_tweets_tracking_title : index_info[lang]['twitter_section']['tweets_tracking_title'],
    twitter_tweets_tracking_keywords_title : index_info[lang]['twitter_section']['twitter_tweets_tracking_keywords_title'],
    twitter_twitter_map_title : index_info[lang]['twitter_section']['twitter_map_title'],
    about : index_info[lang]['about'],
    about_description : index_info[lang]['about_description'],
    teammate_alan_name : index_info[lang]['about_team']['alan_tai']['name'],
    teammate_alan_role : index_info[lang]['about_team']['alan_tai']['role'],
    teammate_alan_description : index_info[lang]['about_team']['alan_tai']['description'],
    contact : index_info[lang]['contact'],
    contact_description : index_info[lang]['contact_description'],
    contact_info_name_title : index_info[lang]['contact_info_name']['contact_info_name_title'],
    contact_info_name_field_placeholder : index_info[lang]['contact_info_name']['contact_info_name_field_placeholder'],
    contact_info_email_title : index_info[lang]['contact_info_email']['contact_info_email_title'],
    contact_info_email_field_placeholder : index_info[lang]['contact_info_email']['contact_info_email_field_placeholder'],
    contact_info_subject_title : index_info[lang]['contact_info_subject']['contact_info_subject_title'],
    contact_info_subject_options_title : index_info[lang]['contact_info_subject']['contact_info_subject_options_title'],
